...
function Navbar() {
    return (
        <Card className="w-[100%] z-50 py-4 fixed top-0 left-0 drop-shadow-lg flex justify-center items-center">
            <Box className="flex items-center xl:w-[85%] w-[90%]">
                <img src={Logo} className="w-[190px]" alt="" />
                <Box className="lg:flex hidden w-[90%]">
                    ...
                    <Stack spacing={2} direction="row" className="ml-[10%]">
                        <Button className="btn colorBtn">Create Meme</Button>
                        <Button className="btn outlineBtn" startIcon={<AccountCircleIcon />}>
                            Log In
                        </Button>
                    </Stack>
                </Box>
