...
export default function BannerCard() {
    return (
        <Box className="w-[100%] lg:h-[85vh] sm:h-[60vh] h-[40vh] relative flex justify-center items-center md:mt-0 mt-5 relative">
            <img src={BannerImg} alt="" className="md:flex hidden w-[100%] h-[100%] absolute top-0 left-0 object-cover object-center" />
